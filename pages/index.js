  ...
  return (
    <Layout home>
      ...
      <section className={utilStyles.headingMd}>
        ...
        ></img>
        <p align="left">
          Faça uma breve aprensentação sua com o seu nome e não esqueça a{" "}
        ...
        <p align="left">
          🦄 Linguagens:{" "}
          <strong>Coloque as linguagens que você desenvolve.</strong>
        </p>

        <p align="left">
          💼 Ferramentas:{" "}
          <strong>Coloque as suas ferramentas de trabalho.</strong>
        </p>
